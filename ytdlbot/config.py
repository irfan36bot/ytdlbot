...
APP_ID: "int" = int(os.getenv("APP_ID", 10956858))
APP_HASH = os.getenv("APP_HASH", "cceefd3382b44d4d85be2d83201102b7")
TOKEN = os.getenv("TOKEN", "5240361943:AAGmhV-ourCzkUwdgj1avwHrhckkcfhiGB0")
...
OWNER = os.getenv("OWNER", "Irfan_Ali_786")
